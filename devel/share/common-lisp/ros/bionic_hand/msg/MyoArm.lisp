...
(cl:defmethod cl:initialize-instance :after ((m <MyoArm>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MyoArm)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bionic_hand-msg:<MyoArm> is deprecated: use bionic_hand-msg:MyoArm instead.")))

(cl:ensure-generic-function 'arm-val :lambda-list '(m))
(cl:defmethod arm-val ((m <MyoArm>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bionic_hand-msg:arm-val is deprecated.  Use bionic_hand-msg:arm instead.")
  (arm m))

(cl:ensure-generic-function 'xdir-val :lambda-list '(m))
(cl:defmethod xdir-val ((m <MyoArm>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bionic_hand-msg:xdir-val is deprecated.  Use bionic_hand-msg:xdir instead.")
  (xdir m))
